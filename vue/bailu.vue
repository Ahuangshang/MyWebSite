    ...
    <scroller>
        <div>
            <image :style="{ width: img_w, height:img_1_h }"
                   src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1504758238532&di=8c41baad497ffe306a83448eb62f34e1&imgtype=0&src=http%3A%2F%2Fpic1.win4000.com%2Fwallpaper%2Fb%2F573be124602a4.jpg"></image>
            <div :style="{ marginLeft: contentMargin,marginRight: contentMargin}">
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{title}}</text>
                <text :style="{ fontSize: tex_size_2 ,marginTop:contentMargin}"> 由来 </text>
                <!--<text style=" font-size: 35px;margin-top: 15px"> 妇女乞巧 </text>-->
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_1}}
                </text>
                <image :style="{ width: img_w, height:img_2_h }"
                       src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1504759602137&di=9eb538edf0234871108dd13990ae1784&imgtype=jpg&src=http%3A%2F%2Fimg4.imgtn.bdimg.com%2Fit%2Fu%3D1079251071%2C1448022454%26fm%3D214%26gp%3D0.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 气候特征 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_2}}
                </text>
                <image :style="{ width: img_w, height:img_3_h }"
                       src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1504759776754&di=8be9ce421fdc9176372721568471d73d&imgtype=0&src=http%3A%2F%2Fimg.mp.sohu.com%2Fq_mini%2Cc_zoom%2Cw_640%2Fupload%2F20170729%2Fb04da86956154825bef65f045badc90c_th.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 民俗 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_3}}
                </text>
                <image :style="{ width: img_w, height:img_4_h }"
                       src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1504759877099&di=92deaf4465e5a0ae1f82dd0e7ad1c565&imgtype=0&src=http%3A%2F%2Fimg1.gtimg.com%2Frushidao%2Fpics%2Fhv1%2F226%2F162%2F1703%2F110779111.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 农事 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_4}}
                </text>
                <image :style="{ width: img_w, height:img_5_h }"
                       src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1504759944040&di=e14c69225f1c5778d2e6323eb4b9f34a&imgtype=0&src=http%3A%2F%2Fpic2.52pk.com%2Ffiles%2Fallimg%2F140911%2F134632OR-14.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px">诗词</text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_5}}
                </text>
            </div>
        </div>
    </scroller>
