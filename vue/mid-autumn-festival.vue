    ...
    <scroller>
        <div>
            <image :style="{ width: img_w, height:img_1_h }"
                   src="https://ahuangshang.github.io/MyWebsite/img/mid-autumn.jpg"></image>
            <div :style="{ marginLeft: contentMargin,marginRight: contentMargin}">
                ...
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_1}}</text>
                <image :style="{ width: img_w, height:img_2_h }"
                       src="https://ahuangshang.github.io/MyWebsite/img/mid-autumn1.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 发展 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_2}}</text>
                <image :style="{ width: img_w, height:img_3_h }"
                       src="https://ahuangshang.github.io/MyWebsite/img/mid-autumn5.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 假期 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_3}}</text>
                <image :style="{ width: img_w, height:img_4_h }"
                       src="https://ahuangshang.github.io/MyWebsite/img/mid-autumn6.jpg"></image>
                <text :style="{ fontSize: tex_size_2}" style="margin-top: 15px"> 风俗习惯 </text>
                <text :style="{ fontSize: tex_size_1,marginTop: topMargin, margin:contentMargin,lineHeight:line_height}"
                      style="color: #334f16;">{{content_4}}</text>
                <image :style="{ width: img_w, height:img_5_h }"
                       src="https://ahuangshang.github.io/MyWebsite/img/mid-autumn7.gif"></image>
